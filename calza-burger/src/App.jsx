...
function App() {
  ...
  const handleStop = async (finalScore) => {
    ...
    try {
      ...
      const gameStock = localDb.gameStock["calza-burger"];

      // Dependiendo de las comandas correctas, mejores premios
      ...
      if (possiblePrizes.length > 0) {
        ...
        // Descontar stock
        localDb.gameStock["calza-burger"][selectedPrizeId]--;
      ...
      const coupon = `R9-CALZA-${day}${month}-${randomStr}`;
